...
| **Other file-transfer**      | Custom integrations (S3 drop, internal file share, etc.) handled per project.     | May be discussed during implementation. Outside the scope of this document.                      |
